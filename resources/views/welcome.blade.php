...
<body
    ...
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-4 not-has-[nav]:hidden">
        @if (Route::has('login'))
    ...
    <nav
        ...
        <a href="#laminate"
            class="px-4 py-2 text-sm font-semibold text-[#1b1b18] hover:text-[#f53003] transition">Laminate</a>
        <a href="#adhesives"
            class="px-4 py-2 text-sm font-semibold text-[#1b1b18] hover:text-[#f53003] transition">Adhesives</a>
    </nav>
    <a href="{{ route('login') }}"
        class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] text-[#1b1b18] border border-transparent hover:border-[#19140035] dark:hover:border-[#3E3E3A] rounded-sm text-sm leading-normal">
        Log in
