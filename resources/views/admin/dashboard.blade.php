    ...
    <div class="space-y-7">
        ...
        <div class="grid grid-cols-1 gap-5 xl:grid-cols-[1fr_360px]">
            <section class="bg-white p-6 shadow-sm">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm font-medium text-gray-500">Pembayaran terverifikasi dalam 6 bulan terakhir.</p>
                    </div>
            ...
            <section class="bg-[#10233d] p-6 text-white shadow-sm">
                <h2 class="text-xl font-black uppercase">Kondisi Pembayaran</h2>
                ...
                <div class="mt-6 space-y-5">
                    <div class="flex items-center justify-between border-b border-white/15 pb-4">
                        <span class="text-sm text-blue-100">Nominal menunggu</span>
                    ...
                    @foreach ($paymentStatusCounts as $status => $count)
                        <div>
                            <div class="flex items-center justify-between text-sm">
                                <span class="font-bold uppercase tracking-[.12em]">{{ \App\Models\Payment::make(['status' => $status])->status_label }}</span>
                                <span>{{ $count }}</span>
                            </div>
                            @php
        ...
        <div class="grid grid-cols-1 gap-5 xl:grid-cols-[1fr_420px]">
            ...
            <section class="bg-white p-6 shadow-sm">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-xl font-black uppercase text-texthighlight">Pembayaran Terbaru</h2>
                        <p class="mt-1 text-sm font-medium text-gray-500">{{ $diprosesOrders }} pesanan aktif diproses.</p>
                    </div>
